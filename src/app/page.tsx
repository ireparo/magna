...
import { waLink, INSTAGRAM, INSTAGRAM_URL } from "@/lib/contact";
  ...
  return (
    <>
      ...
      <section className="py-20 md:py-28 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <Reveal>
            <SectionEyebrow no="05" label="Instagram" align="center" />
            <h2 className="font-display text-[2.4rem] sm:text-[3rem] md:text-[3.6rem] leading-[1.02] tracking-[-0.02em] text-[color:var(--foreground)]">
              Segueix el dia a dia
              <br />
              <span className="font-display-italic text-[color:var(--primary)]">de MAGNA.</span>
            </h2>
            <p className="mt-5 text-base md:text-lg text-[color:var(--foreground-soft)] leading-relaxed max-w-lg mx-auto">
              Exercicis, consells, casos reals i el que passa al centre. Tot al nostre Instagram.
            </p>
            <a
              href={INSTAGRAM_URL}
              target="_blank"
              rel="noopener noreferrer"
              className="mt-8 inline-flex items-center gap-3 btn-primary"
            >
